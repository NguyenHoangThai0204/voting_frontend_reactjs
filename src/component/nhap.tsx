...
//         if(
//           authContext?.user?.email && vote?.listEmailVote?.includes(authContext.user.email) === true
//         ){try {
//           if (authContext?.user) {
//             const dataVote = {
//               pollId: vote._id,
...
//             icon: "error",
//             title: "Oops...",
//             text: "Tài khoản có email không phù hợp với email được cho phép.", showConfirmButton: false,
//             timer: 1500,
//             timerProgressBar: true,
//             showClass: {
//               popup: "swal2-no-animation", // Tắt hiệu ứng xuất hiện
